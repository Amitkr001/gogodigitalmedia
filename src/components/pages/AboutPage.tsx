...
export default function AboutPage() {
  ...
  const milestones = [
    ...
    { year: '2021', title: '100 Artists', description: 'Reached our first milestone of 100 active artists on the platform.' },
    { year: '2022', title: '100+ Platforms', description: 'Expanded distribution to over 100 streaming platforms globally.' },
    { year: '2023', title: '120 Artists', description: 'Hit 100 active artists and distributed over 20,000 tracks.' },
  ...
  const team = [
    ...
    { name: 'Abhay Dehati', role: 'Head of Distribution', initials: 'AD' },
    { name: 'Vikram Singh', role: 'CTO', initials: 'VS' },
    { name: 'Avdhesh Raj', role: 'Head of Artist Relations', initials: 'AR' },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg text-[#A0A0A0] leading-relaxed">
                  Today, with over 120 artists and 20,000+ distributed tracks across 150+ platforms in 180 countries,
